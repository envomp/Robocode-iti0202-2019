...
class MovePrediction
    ...
    private int currentBin() {
        int bin = (int) Math.round(RobotFormulas.normalize(
                RobotFormulas.absBearing(
                        this.gunLocation, targetLocation) - this.bearing) /
                (this.lateralDirection * 0.05833333333333333D) + 12.0D);
